...
def calculates_results_stats(results_dic):
    ...
    try:
        pct_match = round((n_labels/n_images)*100,2)
    except ZeroDivisionError:
        print("Warning! No of images is 0")
        pct_match = 0.00
